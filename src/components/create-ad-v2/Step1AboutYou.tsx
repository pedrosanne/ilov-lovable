  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <h2 className="text-2xl font-bold text-gray-900">🎭 Quem é você?</h2>
        <p className="text-gray-600">Vamos começar com suas informações básicas e como você quer se apresentar</p>
      </div>
